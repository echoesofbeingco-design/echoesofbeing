...
export const metadata: Metadata = {
  title: "Services & Fees | Echos of Being",
  description:
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {plans.map((plan) => (
              <article
                key={plan.title}
                className={`rounded-2xl p-8 border transition-all duration-300 hover:shadow-sm ${
                  plan.highlighted
          ...
          {/* Payment note */}
          <div className="bg-accent-bg/50 rounded-2xl p-8 mb-12">
